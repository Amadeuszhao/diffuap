...
parser.add_argument('--images_root', default=r"/home/zhaowei/diffusion/demo/images", type=str,
                    help='The clean images root directory')
parser.add_argument('--label_path', default=r"/home/zhaowei/diffusion/demo/labels.txt", type=str,
